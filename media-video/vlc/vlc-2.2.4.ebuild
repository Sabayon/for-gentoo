...
src_prepare() {
	...
	# Sabayon mod.: https://bugs.gentoo.org/show_bug.cgi?id=593460
	sed -i '/#include <libavutil\/mem.h>/a#include <libavutil\/channel_layout.h>' \
		modules/codec/avcodec/audio.c || die
