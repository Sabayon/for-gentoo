...
src_prepare() {
	epatch "${FILESDIR}"/patch-1-24.patch
	epatch "${FILESDIR}/EMBOSS-6.4.0-system-pcre.patch"
	epatch "${FILESDIR}/EMBOSS-6.4.0-system-expat.patch"
	epatch "${FILESDIR}/EMBOSS-6.4.0-system-zlib.patch"
	eautoreconf
}
